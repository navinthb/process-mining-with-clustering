...
def get_conformance(full_process_model, cluster_event_log, is_event_log):
    ...
    petri_net, initial_marking_, final_marking = pm4py.convert_to_petri_net(full_process_model)
