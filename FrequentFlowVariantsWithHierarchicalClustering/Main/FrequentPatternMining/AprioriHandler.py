...
## Mine frequent patterns using mlxtend apriori
def mine_frequent_variants(transactions_chunk, min_support):
    ...
    frequent_variants_chunk = apriori(transactions_chunk_df.astype('bool'), min_support=min_support, use_colnames=True)
